...
array( "name" => $themename." Options",
	...
	array(  "name" => "Enable/Disable Content Slider",
			"desc" => "To have content slider working, you'll have to enable it first, then select sliding category and number of slides. Under post, thats under selected sliding category, enter new custom field 'slide' (without '' quotes), and then on the right side in the 'Value' leave the link to the image. Check <a href='$sfirst_img' target='_blank'>this image</a> to make sure you're doing good! Image size should be 960x390px! <b><u>PLEASE FOLLOW README IN THEME'S FOLDER!</u></b> Its all explained, how to set featured images, change the logo, and everything needed!",
	...
	array("name" => "Your Tumblr url",
			"desc" => "Enter your Tumblr URL here (include http://).",
            "id" => $shortname."_tbl",
            "std" => "#",
            "type" => "text"),
